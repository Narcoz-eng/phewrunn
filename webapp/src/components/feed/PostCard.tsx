...
export function PostCard({
  ...
  const tradeDialogSurfaceClassName =
    "flex w-[calc(100vw-0.4rem)] max-h-[calc(100dvh-0.5rem)] max-w-[min(95vw,96rem)] flex-col overflow-hidden border-slate-900/[0.08] bg-[linear-gradient(180deg,rgba(255,252,248,0.98),rgba(244,237,225,0.97))] p-0 text-slate-900 shadow-[0_60px_180px_-56px_rgba(15,23,42,0.34)] dark:border-white/[0.08] dark:bg-[linear-gradient(180deg,rgba(8,10,15,0.99),rgba(5,7,10,0.99))] dark:text-white dark:shadow-[0_60px_180px_-40px_rgba(0,0,0,0.98)] [&>button]:hidden sm:w-[calc(100vw-0.5rem)] sm:max-h-[96vh]";
